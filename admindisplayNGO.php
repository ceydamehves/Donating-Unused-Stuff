...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM sfdlogin JOIN sfdsignin ON sfdlogin.Name = sfdsignin.sfdName WHERE CONCAT(Name,ReceiveGoods,Contact,Email) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
else 
{
    $query = "SELECT * FROM  sfdlogin JOIN sfdsignin ON sfdlogin.Name = sfdsignin.sfdName";
    $search_result = filterTable($query);
}
...
<body>
        ...
        <form action="admindisplaysfd.php" method="post">
    <center>
          <div class="no-print">
